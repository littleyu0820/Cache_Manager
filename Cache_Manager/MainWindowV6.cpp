...
//Main
{
    ...
    QFont btnFont("Segoe UI", 6);
    BrowseAppsBtn->setFont(textFont);
    BrowseAppsBtn->setFixedSize(100,60);
    AddAppsBtn->setFont(textFont);
    AddAppsBtn->setFixedSize(100,60);

    QWidget* CustomPage = new QWidget(this);
    QVBoxLayout* CustomLayout = new QVBoxLayout();

    CustomLayout->addWidget(Custom_Label);

    CustomLayout->addWidget(BrowseAppsBtn);
    CustomLayout->addWidget(AddAppsBtn);
